class Song {
  ...
  Song({required this.title, required this.album, required this.artist, required this.date, required this.imageURL,
  required this.appleMusicURL, required this.spotifyURL, required this.generalURL});
